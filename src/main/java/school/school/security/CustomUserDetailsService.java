...
@Service // On dit à Spring que c'est un composant de service qu'il doit gérer
public class CustomUserDetailsService implements UserDetailsService{
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        Etudiant etudiant = etudiantRepository.findByEmail(email).orElseThrow(() -> new UsernameNotFoundException("Aucun étudiant trouvé avec l'email : " + email));
